package theStarKnight.events;
        ...
        import theStarKnight.relics.MawHelm_SKRelic;
    ...
    protected void buttonEffect(int i) { // This is the event:
        switch (screenNum) {
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    case 0:
                        imageEventText.loadImage("theStarKnightResources/images/events/BronzeMirror_E_3_SK.png"); // Change the shown image
                        this.use();
                    ...
                    case 1: // If you press button the second button
                        ...
                        imageEventText.loadImage("theStarKnightResources/images/events/BronzeMirror_E_2_SK.png"); // Change the shown image
