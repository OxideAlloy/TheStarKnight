...
//      this(name, id, maxHealth, hb_x, hb_y, hb_w, hb_h, imgUrl, offsetX, offsetY, false);
        ...
        this.loadAnimation("theStarKnightResources/images/monsters/ShoggothA/skeleton.atlas", "theStarKnightResources/images/monsters/ShoggothA/skeleton.json", 1.0F);
