...
public class ShoggothB extends AbstractMonster {
    ...
    public ShoggothB(float x, float y) {
        ...
        this.loadAnimation("theAdventurerResources/images/monsters/ShoggothB/skeleton.atlas", "theAdventurerResources/images/monsters/ShoggothB/skeleton.json", 1.0F);
