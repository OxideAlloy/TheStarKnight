...
import theAdventurer.cards.AbstractDefaultCard;
import theAdventurer.characters.TheDefault;
import theAdventurer.events.BronzeMirrorEvent;
import theAdventurer.monsters.ShoggothA;
import theAdventurer.monsters.ShoggothB;
import theAdventurer.monsters.ShoggothC;
import theAdventurer.potions.IchorPotion;
...
import theAdventurer.variables.DefaultSecondMagicNumber;
...
// DON'T MASS RENAME/REFACTOR - OK
// Please don't just mass replace "theDefault" with "yourMod" everywhere.
// It'll be a bigger pain for you. You only need to replace it in 4 places.
// I comment those places below, under the place where you set your ID.

// FIRST THINGS FIRST: RENAME YOUR PACKAGE AND ID NAMES FIRST-THING!!! - DONE
...
public class DefaultMod implements
    ...
    private static final String MODNAME = "The Adventurer";
    private static final String AUTHOR = "OxideAlloy"; // And pretty soon - You!
    private static final String DESCRIPTION = "Adds The Adventurer to Slay the Spire.";
    ...
    private static final String ATTACK_COLOUR_OUT_OF_SPACE = "theAdventurerResources/images/512/Attack_SK_512.png";
    private static final String SKILL_COLOUR_OUT_OF_SPACE = "theAdventurerResources/images/512/Skill_SK_512.png";
    private static final String POWER_COLOUR_OUT_OF_SPACE = "theAdventurerResources/images/512/Power_SK_512.png";
    
    private static final String ENERGY_ORB_COLOUR_OUT_OF_SPACE = "theAdventurerResources/images/512/OrbLarge2.png";
    private static final String CARD_ENERGY_ORB = "theAdventurerResources/images/512/OrbSmall2.png";
    
    private static final String ATTACK_COLOUR_OUT_OF_SPACE_PORTRAIT = "theAdventurerResources/images/1024/Attack_SK_1024.png";
    private static final String SKILL_COLOUR_OUT_OF_SPACE_PORTRAIT = "theAdventurerResources/images/1024/Skill_SK_1024.png";
    private static final String POWER_COLOUR_OUT_OF_SPACE_PORTRAIT = "theAdventurerResources/images/1024/Power_SK_1024.png";
    private static final String ENERGY_ORB_COLOUR_OUT_OF_SPACE_PORTRAIT = "theAdventurerResources/images/1024/OrbLarge2_Big.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theAdventurerResources/images/charSelect/Button_SK.png";
    private static final String THE_DEFAULT_PORTRAIT = "theAdventurerResources/images/charSelect/PortraitBG_SK.png";
    ...
    public static final String BADGE_IMAGE = "theAdventurerResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theAdventurerResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theAdventurerResources/images/char/defaultCharacter/skeleton.json";
...
//        BaseMod.addEvent(eventParams);
    ...
    public void receiveEditCards() {
        ...
        // Rename the "DefaultMod" with the modid in your ModTheSpire.json file - DONE
        // The artifact mentioned in ModTheSpire.json is the artifactId in pom.xml you should've edited earlier
        new AutoAdd("theAdventurer") // ${project.artifactId}
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(CardStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Card-Strings.json");
        
        // PowerStrings
        BaseMod.loadCustomStringsFile(PowerStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Power-Strings.json");
        
        // RelicStrings
        BaseMod.loadCustomStringsFile(RelicStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Relic-Strings.json");
        
        // Event Strings
        BaseMod.loadCustomStringsFile(EventStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Event-Strings.json");
        
        // PotionStrings
        BaseMod.loadCustomStringsFile(PotionStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Potion-Strings.json");
        
        // CharacterStrings
        BaseMod.loadCustomStringsFile(CharacterStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Character-Strings.json");
        
        // OrbStrings
        BaseMod.loadCustomStringsFile(OrbStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Orb-Strings.json");

        // UI Strings
        BaseMod.loadCustomStringsFile(UIStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-UI-Strings.json");

        // Monster Strings
        BaseMod.loadCustomStringsFile(MonsterStrings.class,
                getModID() + "Resources/localization/eng/theAdventurer-Monster-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(getModID() + "Resources/localization/eng/theAdventurer-Keyword-Strings.json").readString(String.valueOf(StandardCharsets.UTF_8));
